  ...
  return (
    <div className='banner'>
      <div className={`max-w-[1400px] mx-auto flex ${!hoverId && 'gap-5'}`}>
        <div
          className='flex-1 h-[300px] grid grid-row-11 text-[20px] rounded-[20px]
        ...
        >
          {data_DanhMuc.map((item) => (
            ...
            >
              <div className='hover:bg-[#fa7833] h-full flex gap-4 items-center hover:text-[white] pl-[20px]'>
        ...
        <div
          className={`flex-3 grid grid-cols-4 gap-2 bg-[white] rounded-[20px] ${
            !hoverId && 'hidden'
          } shadow-xl`}
        ...
        >
          {isfilter?.type.map((item) => (
            <div className='p-5' key={item.id}>
              ...
              {item.children?.map((i) => (
                <div
                  className='flex flex-col gap-2 hover:cursor-pointer hover:text-[#29A07E]'
                  key={i.id}
                >
