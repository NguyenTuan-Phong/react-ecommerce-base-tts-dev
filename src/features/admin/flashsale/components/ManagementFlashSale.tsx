...
import type { contentFlashSale } from "../../../../types"
...
const ManagementFlashSale = () => {
    ...
    const {
        ...
        ResponseFlashSale,
        refetchFlashSale
    } = useGetAllFlashSale(page, size, searchName, searchStartTime, searchEndTime)

    const {
        isLoadingDeleteFlashSale,
        handleDeleteFlashSale
    } = useDeleteFlashSale(refetchFlashSale)
    ...
    const columns = [
        {
            key: "id",
            render: (record: contentFlashSale) => {
                return <Link to={`/admin/view-detail-flashsale/${record.id}`} className="flex items-center gap-2"
                >
        ...
        },
        {
            title: "Thao tác",
            key:"action",
            render: (_: any, record: contentFlashSale) => (
            ...
            <div className="flex gap-3">
                ...
                >
                    ...
                    <Form.Item>
                        <Button 
                        htmlType="submit"
                        className="h-12! bg-[#22a085]! text-[white]!">
                            Tìm kiếm
                        </Button>
                    </Form.Item>
                    <Form.Item>
