import { Avatar, Button, DatePicker, Form, Input, Pagination, Table, type FormInstance } from "antd"
import {
    ArrowLeftOutlined
...
const UpdateFlashSale = () => {
    ...
    } = useUpdateFlashSale(refetchFlashSale)
    ...
    const submitFormUpdateFlashSale = (value: FormCreatFlashSale) => {
        ...
        const isProductChanged = confirmedRows.length !== flashSaleData?.products.length ||
    ...
    const rowSelection = {
        ...
        onChange: (newSelectedKeys: React.Key[], selectedRows: any[]) => {
            const unlockedKeys = newSelectedKeys.filter(
                (key) => !lockedRowKeys.includes(String(key))
            );
    ...
    const columns = [
        ...
        },
        {
            ...
            key: "publisher",
            render: (_: any, record: any) =>
                record.publisher?.name ?? "Không xác định",
        },
        {
            title: 'Số lượng',
            key: 'quantityFlashSale',
            render: (_: any, record: any) => {
                const shouldShow = selectedRowKeys.includes(record.id) || lockedRowKeys.includes(String(record.id));
                ...
                return (
                    ...
                    >
                        ...
                        rules={[
                            { 
                                required: true, message: 'Vui lòng điền giá trị số lượng' 
                            },
                            {
                                validator: (_, value) =>
            ...
            render: (_: any, record: any) => {
                ...
                return (
                    ...
                    >
                        ...
                        >
                            <Input type="number" placeholder="% giảm" suffix="%" className="h-12 w-full max-w-xs" />
                        </Form.Item>
            ...
            <div className="flex flex-col gap-3">
                ...
                >
                    <div >
                        ...
                        >
                            <Input 
                                placeholder="Điền tên chiến dịch"
                                className="h-12!"
                            />
                        </Form.Item>
                        <Form.Item
                    ...
                    <div className="flex-1 flex">
                        ...
                        <div className="flex flex-col">
                            ...
                            >
                                <Button 
                                htmlType="submit"
                                className="h-12! px-15! w-full bg-[#22a085]! text-white!"
