...
const ViewDetailFlashSale = () => {
  ...
  const { isLoadingGetFlashSaleById, ResponseFlashSaleById } = useGetFlashSaleById(id!);
  ...
  const data = useMemo(() => ResponseFlashSaleById ?? defaultFlashSale, [ResponseFlashSaleById]);
        ...
        <div>
          ...
          <div className='text-center text-[22px] p-3'>
            <b className='text-center'>
              Chiến dịch giảm giá: <b className='text-red-500'>{data.data.name}</b>
            </b>
          </div>
          <div className='bg-white flex flex-col gap-10'>
            <div className='flex gap-20'>
              ...
              <p>
                ...
                {dayjs(data.data.endTime).format('DD/MM/YYYY, HH:mm')}
              </p>
              <p>
            ...
            <div>
              <Button className='bg-green-700! text-[white]! h-12! px-10!'>
                ...
                {data.data.products.map((product) => (
                  <div key={product.productId} className='bg-gray-100 p-4 rounded-lg shadow-md'>
                    ...
                    <div className='mt-4'>
                      ...
                      <p className='text-[14px] text-gray-600 h-[24px] truncate'>
                        {product.description}
                      </p>
                      <p className='text-md font-bold mt-2'>
                        Giá: {product.flashPrice.toLocaleString()} VND
                      </p>
