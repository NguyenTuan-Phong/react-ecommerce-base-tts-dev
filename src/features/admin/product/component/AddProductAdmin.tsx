    ...
    const [form] = Form.useForm();
     const navigate = useNavigate();
        ...
        const handleAddProduct = (values: any) => {
            const imageFile = values.imageFile?.[0]?.originFileObj; // 👈 File thật
    ...
    <>
        <div>
            <div className="flex gap-3">
                <Button
                className="bg-[#22a085] text-white" 
            ...
            <Form layout="vertical" onFinish={handleAddProduct} form={form} className="w-full">
                ...
                gutter={[48, 48]} 
                align={"middle"}
                className="mt-1 rounded-[12px] w-280"
                >
                <Col xs={24} sm={24} md={16} lg={16} >
                    ...
                    <div className="flex gap-5">
                        <Form.Item label="Số lượng sản phẩm" name="quantity" required
                            rules={[{
                                required: true, message: "Nhập tên sản phẩm"
                            }]}
                        >
                        ...
                        <Form.Item label="Giá bán" name="price" required
                            rules={[{
                                required: true, message: "Nhập giá bán sản phẩm"
                            }]}
                        >
                ...
                <div className="bg-white shadow rounded-xl p-4 flex flex-col gap-4 mt-5">
                    ...
                    >
                    <Select placeholder="Chọn loại sản phẩm" disabled={!selectedCategoryId} className="h-12!">
