        ...
        <div className='flex flex-col gap-3'>
          ...
          <div className='flex flex-col sm:flex-row gap-2'>
            ...
            <div className='flex gap-1 sm:w-1/2'>
              ...
              <div className='font-bold'>HƯỚNG DẪN KẾT NỐI TAY CẦM PS4 VỚI PC VÀ ĐIỆN THOẠI</div>
            </div>
          </div>
          <div className='flex flex-col sm:flex-row gap-2'>
            ...
            <div className='flex gap-1 sm:w-1/2'>
              ...
              <div className='font-bold'>DỊCH VỤ IN LÓT CHUỘT THEO YÊU CẦU TẠI Codec</div>
            </div>
          </div>
        </div>
      </section>
      <section className='flex-1 bg-[white] p-5 rounded-[8px] flex flex-col gap-4'>
        ...
        <div className='flex flex-col gap-3'>
          <div className='relative'>
            <img className='rounded-[8px] hover:cursor-pointer' src={LED} alt='LED' />
